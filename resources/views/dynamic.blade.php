            ...
            <div id="primary" class="content-area mg-banded-secondary-lightest mg-noise">
                <main id="main" role="main" class="site-main">
                    ...
                    <div class="back-blue text-center">
                        ...
                        @if ($tab == 2)
                            <div class="flex justify-center">
                                <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/Benzene"
                                ...
                                <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/CO"
                                ...
                                <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/CO2"
                                ...
                                <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/NOx"
                                ...
                                <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/PM"
                                ...
                                <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/VOC"
                                ...
                                <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/Vehicle Fleet"
                    ...
                    @if ($tab == 3)
                        <div class="flex justify-center">
                            <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/RED III"
                            ...
                            <a href="{{ route(__('routes.tools')) }}/{{ $tab }}/{{ $continentid }}/{{ str_replace(' ', '', $regionid) }}/GREET"
                                                                ...
                                                                plugins: {
                                                                    ...
                                                                    tooltip: {
                                                                        callbacks: {
                                                                            ...
                                                                            @if ($type == '_lt')
                                                                                label: (ctx) =>
                                                                                    ` ${Number(ctx.parsed.x).toLocaleString(undefined, { maximumFractionDigits: 0 })}  MML/yr`
                                                                            @else
                                                                                label: (ctx) =>
                                                                                    ` ${Number(ctx.parsed.x).toLocaleString(undefined, { maximumFractionDigits: 0 })}  MMGal/yr`
                                                                            @endif
                                                                        }
                                                                    },
                                                                    datalabels: {
                                                                ...
                                                                plugins: {
                                                                    ...
                                                                    tooltip: {
                                                                        callbacks: {
                                                                            ...
                                                                            @if ($type == '_lt')
                                                                                label: (ctx) =>
                                                                                    ` ${Number(ctx.parsed.x).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} RON`
                                                                            @else
                                                                                label: (ctx) =>
                                                                                    ` ${Number(ctx.parsed.x).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} RON`
                                                                            @endif
                                                            ...
                                                            options: {
                                                                ...
                                                                plugins: {
                                                                    ...
                                                                    tooltip: {
                                                                        ...
                                                                        intersect: true,
                                                                        callbacks: {
                                                                            // En horizontal, el valor debera sumar a si mismo +  el dato anterior
                                                                            label: (ctx) => {
                                                                                // Suma acumulada de todos los datasets hasta el actual en la misma posición
                                                                                let acumulado = 0;
                                                                                for (let i = 0; i <= ctx.datasetIndex; i++) {
                                                                                    acumulado += Number(ctx.chart.data.datasets[i].data[ctx
                                                                                        .dataIndex]) || 0;
                                                                                }
                                                                                return ` ${ctx.dataset.label}: ${Number(acumulado).toLocaleString(undefined, { maximumFractionDigits: 0 })} ${unidad}`;
                                                                            }
                                                                        }
                                                                    },
                                                                    datalabels: {
                                                                ...
                                                                plugins: {
                                                                    ...
                                                                    tooltip: {
                                                                        callbacks: {
                                                                            // En horizontal, el valor está en parsed.x
                                                                            @if ($type == '_lt')
                                                                                label: (ctx) => ` ${Math.round(ctx.parsed.x).toLocaleString()}  MML/yr`
                                                                            @else
                                                                                label: (ctx) =>
                                                                                    ` ${Math.round(ctx.parsed.x).toLocaleString()}  MMGal/yr`
                                                                            @endif
                                                                        }
                                                                    },
                                                                    datalabels: {
                                                                ...
                                                                plugins: {
                                                                    ...
                                                                    tooltip: {
                                                                        callbacks: {
                                                                            // En horizontal, el valor está en parsed.x
                                                                            label: (ctx) =>
                                                                                ` ${Number(ctx.parsed.x).toLocaleString(undefined, { minimumFractionDigits: 1, maximumFractionDigits: 1 })} %`
                                                                        }
                                                                    },
                                                                    datalabels: {
                                                                        anchor: 'end',
                                                        ...
                                                        if (ctx1) {
                                                            ...
                                                            const legendSpacing = {
                                                                ...
                                                                beforeInit(chart, args, opts) {
                                                                    const extra = opts?.extraLegendHeight ?? 30;
                                                            ...
                                                            new Chart(ctx1.getContext('2d'), {
                                                                ...
                                                                options: {
                                                                    ...
                                                                    plugins: {
                                                                        legendSpacing: {
                                                                            extraLegendHeight: 20
                                                                        }, // 👈 ajusta 20/30/60 a tu gusto
                                                                        legend: {
                                                                            display: true,
                                                                            position: 'top',
                                                                            labels: {
                                                                ...
                                                                options: {
                                                                    ...
                                                                    plugins: {
                                                                        ...
                                                                        tooltip: {
                                                                            callbacks: {
                                                                                label: (ctx) =>
                                                                                    ` ${Number(ctx.parsed.x).toLocaleString(undefined, { maximumFractionDigits: 0 })} Units`
                                                                            }
                                                                        },
                                                                        datalabels: {
                                                                            anchor: 'end',
