...
Route::group(['prefix' => 'en', 'middleware' => 'translate'], function() {
    ...
    Route::get('/dynamic-tools/{tab?}/{continent?}/{regionid?}/{type?}', '\App\Http\Controllers\MainController@tools')
    ->whereNumber('tab')
...
Route::group(['prefix' => 'es', 'middleware' => 'translate'], function() {
    ...
    Route::get('/herramientas-dinamicas/{tab?}/{continent?}/{regionid?}/{type?}', '\App\Http\Controllers\MainController@tools')
    ->whereNumber('tab')
    ->whereNumber('continent')
    ->whereNumber('region')
    ->name('herramientas-dinamicas');
