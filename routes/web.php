...
Route::group(['prefix' => 'en', 'middleware' => 'translate'], function() {
    ...
    Route::get('/dynamic-tools/{tab?}/{continent?}/{regionid?}/{type?}', '\App\Http\Controllers\MainController@tools')->name('dynamic-tools');
...
Route::group(['prefix' => 'es', 'middleware' => 'translate'], function() {
    ...
    Route::get('/herramientas-dinamicas/{tab?}/{continent?}/{regionid?}/{type?}', '\App\Http\Controllers\MainController@tools')->name('herramientas-dinamicas');
